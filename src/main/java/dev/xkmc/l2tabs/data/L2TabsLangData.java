...
import dev.xkmc.l2tabs.L2TabsData;
...
public enum L2TabsLangData
{
    ...
    private final String key, defEn, defZh;
    ...
    public static void genLang()
    {
        for (L2TabsLangData lang : L2TabsLangData.values())
            L2TabsData.EN_TEXTS.addText(lang.key, lang.defEn);
        for (L2TabsLangData lang : L2TabsLangData.values())
            L2TabsData.ZH_TEXTS.addText(lang.key, lang.defZh);
    }
}
